...
- (void)getDataCompletionHandle:(void (^)(NSError *))completed {
    self.dataTask = [MZHomeNetManager getTracksForAlbumId:_albumId mainTitle:_title idAsc:_asc completionHandle:^(DestinationModel* responseObject, NSError *error) {
