...
@interface MZHomeModel ()
@property (nonatomic,strong) ContentsModel *model;
@end

@implementation MZHomeModel
...
- (void)getDataCompletionHandle:(void (^)(NSError *))completed {
    ...
    self.dataTask = [MZHomeNetManager getContentsForForCategoryId:_categoryId contentType:_type completionHandle:^(ContentsModel* responseObject, NSError *error) {
