...
#import "MZHomeNetManager.h"
#import "ContentCategoryModel.h"

@interface MZCategoryViewModel ()

@property (nonatomic,strong) ContentCategoryModel *model;

@end

@implementation MZCategoryViewModel
...
- (void)getDataCompletionHandle:(void (^)(NSError *))completed {
    ...
    self.dataTask = [MZHomeNetManager getCategoryForCategoryId:_categoryId tagName:_name pageSize:_pageSize completionHandle:^(ContentCategoryModel* responseObject, NSError *error) {
