...
@interface ContentsModel : MZBaseModel
...
@end
@interface ContentFocusimages : MZBaseModel
...
@interface CFocusimages_List : MZBaseModel
...
@interface ContentTags : MZBaseModel
...
@interface ContentTags_List : MZBaseModel
...
@interface ContentCategorycontents : MZBaseModel
...
@interface CCategoryCotents_List : MZBaseModel
...
@interface CCategoryCotents_L_List : MZBaseModel
...
@interface CC_L_L_Firstkresults : MZBaseModel
